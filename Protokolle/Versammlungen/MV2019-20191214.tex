...
\ohead{Protokoll der AMV des Hackspace Jena
...
\newcommand{\lowlevel}{Fabian Thoms}
\newcommand{\fiveop}{Philipp Schäfer}
\newcommand{\jonny}{Jonny Maik Müller}
\newcommand{\philipp}{Philipp Galindo Kotchev}
...
\thispagestyle{plain}
\section*{Protokoll der außerordentlichen Mitgliederversammlung des Hackspace Jena
e.\,V.}
...
\section{Begrüßung}
Um 14:19~Uhr eröffnet der amtierende Vorstandsvorsitzender \qbi{} die Versammlung mit der
...
Die Protokolle der Versammlung aus dem September 2018 sind zum Zeitpunkt der
Versammlung bei Github veröffentlicht. 

Es erfolgt eine Erläuterung Unterschiede der öffentlichen und offiziellen Version des Protokolls. Letzteres enthält deutlich mehr persönliche Daten.
...
Am 9.\,Dezember~2019 erfolgte die Kassenprüfung durch \philipp{} und  \ckv. Auf der
Mitgliederversammlung gibt \philipp{} einen Bericht über die Kassenprüfung ab. Für die Barkasse wurden Buchungen (Filter: 05.09.2019-31.12.2020, Konto 0 - Barkasse, Projekt Verein/Raum) und Stand geprüft. Zu allen Buchungen waren Belege vorhanden. Die Barkasse enthielt 33 Cent zu viel (im Vergleich zu 10 Cent
...
Der \quanten{} nimmt die Funktion des Wahlleiters ein.
...
Es wird über die Funktion von stimmberechtigten Beisitzern als demokratisches Element diskutiert, wobei der Vorstand den Verein nach außen vertreten muss, wobei unklar ist, welche Rolle hier die stimmberechtigten Beisitzer spielen. Auch würde die Mehrheitsfindung mit bis zu 6 Stimmberechtigten im Vorstand, der ja möglichst ein Team darstellen solle, schwerer. Der Aufwand einer Satzungsänderung wird genannt. 
...
Der alte Vorstand weißt darauf hin, dass Beisitzer persönliche Informationen einsehen dürfen, bei jeder Vorstandssitzung dabei seien dürfen und das dies die Planung dieser verlangsamen könnte. Ein Mitglied merkt an, dass die MV in der nun kommenden Wahl immer noch keinem Beisitzer eine genügendende Mehrheit geben könnte und es somit zu keinem Beisitzer kommen könnte. 
...
Es folgt eine geheime Abstimmung. Jedes Mitglied kann für jeden Kandidaten Vorschlag mit Ja/Nein/Enthaltung stimmen. Es werden die drei Beisitzer, die die meisten Ja-Stimmen gewählt, zusätzlich muss jeder Kandidat mehr als die Häfte Ja-Stimmen erhalten haben.
...
\isi{}, \quanten{} und \philipp{} nehmen die Wahl an.


Um 17:03 verlässt \philipp{} die Versammlung. Nun sind noch 14 stimmberechtigte Mitglieder anwesend.
...
Die Versammlung wird um 16:56~Uhr durch den neuen Vorstand für  beendet erklärt.
...
??Hä, soll das hier so bleiben, muss das hier rein, es kein TOP, wie in der Einladung, also darf es hier nicht rein oder??

Der Vorstand des Hackspace Jena e.\,V. setzt sich  seit der AMV am 7.\,Sep\-tem\-ber~2019
wie folgt zusammen:
...
\section{Liste der Anwesenden zur Außerordentlichen Mitgliederversammlung 2019}
